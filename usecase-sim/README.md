...
- **What it exercises:** 34 named scenarios that combine 2 engines, 3 metadata
...
The positive validator reconciles 24 unique outputs (72 total rows), including
literal regex replacement, equal-order declaration stability, value rules
before schema casting, and partial masking of null and empty strings.
