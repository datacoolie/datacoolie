...
# produces: dist/datacoolie-0.1.0-py3-none-any.whl
```

### 2 — Upload wheel to S3

```bash
aws s3 cp dist/datacoolie-0.1.0-py3-none-any.whl \
    s3://de-dev-0007/libraries/datacoolie-0.1.0-py3-none-any.whl \
...
| Parameter | Value |
|---|---|
| `--extra-py-files` | `s3://de-dev-0007/libraries/datacoolie-0.1.0-py3-none-any.whl` |
...
|---|---|
| `--extra-py-files` | `s3://de-dev-0007/libraries/datacoolie-0.1.0-py3-none-any.whl,s3://de-dev-0007/libraries/functions.zip` |
